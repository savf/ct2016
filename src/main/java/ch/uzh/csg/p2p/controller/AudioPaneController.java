...
public class AudioPaneController {
  ...
  public void startAudioHandler() throws ClassNotFoundException, IOException,
    ...
    for (String chatPartner : mainWindowController.currentChatPartners) {
      ...
      AudioRequest request =
          new AudioRequest(RequestType.SEND, RequestStatus.WAITING, node.getFriend(chatPartner)
  ...
  public void endAudioHandler() throws LineUnavailableException {
    ...
    for (String chatPartner : mainWindowController.currentChatPartners) {
      AudioRequest request =
          new AudioRequest(RequestType.SEND, RequestStatus.ABORTED, node.getFriend(chatPartner)
              .getPeerAddress(), chatPartner, node.getUser().getUsername());
      RequestHandler.handleRequest(request, node);
    }
  ...
  public void startAudioCall() throws ClassNotFoundException, IOException, LineUnavailableException {
  ...
  public void acceptAudioCall(String username) throws ClassNotFoundException, IOException,
      LineUnavailableException {
  ...
  public void audioCallRejected(final AudioRequest audioRequest) throws ClassNotFoundException,
  ...
  private void addChatPartner(String username, String labelPostfix) throws LineUnavailableException {
