...
public class ChatBubbleController {
	...
	Image bubbleMeImage = new Image(MainWindow.class.getResourceAsStream("/bubble_me.png"), 34, 35,
			false, true);
	Image bubblePeerImage = new Image(MainWindow.class.getResourceAsStream("/bubble_peer.png"), 34,
			35, false, true);
	BackgroundPosition backgroundPositionBottomLeft = new BackgroundPosition(Side.LEFT, 0, true,
			Side.BOTTOM, 0, true);
	BackgroundPosition backgroundPositionBottomRight = new BackgroundPosition(Side.RIGHT, 0, true,
			Side.BOTTOM, 0, true);
